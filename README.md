...
| `zigbee2mqtt_tuya_door_sensor` | Zigbee2MQTT template for [Sonoff Contact sensor](https://www.zigbee2mqtt.io/devices/SNZB-04.html#sonoff-snzb-04) | ***_door_sensor_***, battery_power, value_sensor | x_mqtt_device.poll[^3] | - |
| `zigbee2mqtt_tuya_occupancy_illuminance` | Zigbee2MQTT template for [TuYa Luminance motion sensor](https://www.zigbee2mqtt.io/devices/ZG-204ZL.html#tuya-zg-204zl) | ***_motion_sensor_***, light_sensor, battery_power, value_sensor | x_mqtt_device.poll[^3] | - |
| `zigbee2mqtt_tuya_illuminance_occupancy` | Zigbee2MQTT template for [TuYa Luminance motion sensor](https://www.zigbee2mqtt.io/devices/ZG-204ZL.html#tuya-zg-204zl) | ***_light_sensor_***, motion_sensor, battery_power, value_sensor | x_mqtt_device.poll[^3] | zigbee2mqtt_tuya_occupancy_illuminance.yaml |
